...
\begin{tikzpicture}[squarednode_odd/.style={rectangle, draw=red!60, minimum width=2.6mm, node distance = 0.1 pt},
squarednode_even/.style={rectangle, draw=blue!60, minimum width=2.6mm, node distance = 0.1 pt},
squarednode_2/.style={rectangle, draw=green!60,very thick, minimum width=2.6mm, node distance = 0.1 pt}]
    \node[squarednode_odd]       (1)                                     {o};
    ...
    \node[rectangle ,draw=red!60, minimum width=2.6mm] (o) [below=of 3] {o};
    \node[rectangle , node distance = 20pt, very thick] (legendodd) [right=of o] {choose random positions for odd numbers};
    \node[rectangle ,draw=green!60,very thick, minimum width=2.6mm ,node distance = 10pt] (two) [below=of o] {2};
    \node[rectangle , node distance = 20pt, very thick] (legendtwo) [right=of two] {place 2 in the first empty space};
    \node[rectangle ,draw=blue!60, minimum width=2.6mm , node distance = 10pt] (e) [below=of two] {e};
    \node[rectangle , node distance = 20pt, very thick] (legendeven) [right=of e] {place remaining even numbers};
